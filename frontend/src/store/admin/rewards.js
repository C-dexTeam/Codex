 ...
 */
export const fetchRewards = createAsyncThunk('admin/adminRewards/fetchRewards', async (_, { rejectWithValue, getState }) => {
    try {
        const response = await axios.get(`${process.env.NEXT_PUBLIC_BASE_URL}/private/rewards`, { params: { ...getState().admin.adminRewards.filters } });
 ...
 */
export const fetchReward = createAsyncThunk('admin/adminRewards/fetchReward', async (id, { rejectWithValue }) => {
    try {
 ...
 */
export const createReward = createAsyncThunk('admin/adminRewards/createReward', async ({ formData, callback }, { dispatch, rejectWithValue }) => {
    try {
 ...
 */
export const updateReward = createAsyncThunk('admin/adminRewards/updateReward', async ({ formData, callback }, { dispatch, rejectWithValue }) => {
    try {
 ...
 * @param {string} id - Reward ID (required).
 */
export const deleteReward = createAsyncThunk('admin/adminRewards/deleteReward', async (id, { rejectWithValue, dispatch }) => {
    try {
...
export const getLoading = (state) => state.admin.adminRewards.loading;
export const getReward = (state) => state.admin.adminRewards.reward;
export const getRewards = (state) => state.admin.adminRewards.data;
export const getCurrentReward = (state) => state.admin.adminRewards.reward;
export const getTotalCount = (state) => state.admin.adminRewards.totalCount;
export const getFilters = (state) => state.admin.adminRewards.filters;

export const { setCurrentReward, setFilters } = adminRewardsSlice.actions;
